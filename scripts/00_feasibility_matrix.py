...
datasets = [
    ...
    },
    {
        ...
        "source": "https://competitions.codalab.org/competitions/11161",
        "public_access": "BLOCKED - original competition site; data links likely expired",
        "click_info": "YES (if accessible) - view events with queries + rankings",
        "purchase_info": "YES (if accessible) - purchase events",
        "add_to_cart": "Unknown",
        "timestamps": "YES (if accessible)",
        "session_ids": "YES",
        "exposure_order": "Can potentially use search result rank as exposure order",
        "hypothesis_coverage": "H1-H5 potentially (has search queries for intent proxies)",
        "key_limitations": "BLOCKED: competition data likely no longer downloadable. Some GitHub repos may have processed versions but lose key fields.",
        "overall_rating": "BLOCKED - excellent if accessible, but likely unavailable",
        "downloaded": False,
    },
    {
        "dataset": "Coveo SIGIR eCom",
        "source": "https://github.com/coveooss/SIGIR-ecom-data-challenge",
        "public_access": "UNCERTAIN - may require agreement/application",
        "click_info": "YES (if accessible) - browsing events with search context",
        "purchase_info": "YES (if accessible) - add-to-cart and purchase",
        "add_to_cart": "YES (if accessible)",
        "timestamps": "YES",
        "session_ids": "YES",
        "exposure_order": "Can use search result position as exposure order",
        "hypothesis_coverage": "H1-H5 potentially (search queries + result positions)",
        "key_limitations": "Access uncertain; may require data use agreement.",
        "overall_rating": "NOT TESTED - worth investigating manually",
        "downloaded": False,
    },
    {
